    ...
    def start_discrimination_exercise(self):
            ...
            try:
                ...
                if os.path.exists(exe_path):
                    ...
                    self.exercise_status.configure(text="Bài tập đã khởi động thành công! (EXE)")
                    ...
                    self.exercise_status.configure(text="Bài tập đã khởi động thành công! (Python)")
                
                else:
                    # Neither file exists
                    messagebox.showerror("Lỗi", "Không tìm thấy discrimination.exe hoặc discrimination.py!")
                ...
                messagebox.showerror("Lỗi", f"Không thể khởi động bài tập: {str(e)}")
